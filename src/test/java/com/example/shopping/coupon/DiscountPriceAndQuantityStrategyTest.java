...
public class DiscountPriceAndQuantityStrategyTest {
    ...
    @Before
    public void setup() {
        couponStrategy = new DiscountPriceAndQuantityStrategy();
    ...
    @Test
    public void checkCouponThreshold() {
        Boolean result = couponStrategy.checkCouponThreshold(this.order,new Coupon().setThresholdQuantity(3F).setThresholdPrice(300F));
    ...
    public void checkCouponThresholdFailed() {
        Boolean result = couponStrategy.checkCouponThreshold(this.order,new Coupon().setThresholdQuantity(5F).setThresholdPrice(500F));
